...
const en = {
  ...
  stake: {
    ...
    quoteUnavailable: 'Quote unavailable for this token',
    youSend: 'You send',
    estWeth: 'Est. WETH',
    estPufEth: 'Est. pufETH',
    stakeViaSwap: 'Stake via Swap',
    advApprove: 'Approve token',
    advSwap: 'Swap via 1inch',
    advStake: 'Stake to pufETH',
    poweredBy1inch: 'Powered by 1inch',
    viewApproveTx: 'View approval transaction',
    viewSwapTx: 'View swap transaction',
    viewStakeTx: 'View stake transaction',
  },
  vaults: {
    title: 'Vaults',
    testnetNote:
...
const es: Messages = {
  ...
  stake: {
    ...
    quoteUnavailable: 'Cotización no disponible para este token',
    youSend: 'Envías',
    estWeth: 'WETH est.',
    estPufEth: 'pufETH est.',
    stakeViaSwap: 'Stake vía swap',
    advApprove: 'Aprobar token',
    advSwap: 'Swap vía 1inch',
    advStake: 'Stake a pufETH',
    poweredBy1inch: 'Powered by 1inch',
    viewApproveTx: 'Ver transacción de aprobación',
    viewSwapTx: 'Ver transacción de swap',
    viewStakeTx: 'Ver transacción de stake',
  },
  vaults: {
    title: 'Bóvedas',
    testnetNote:
